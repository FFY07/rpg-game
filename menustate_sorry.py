...
def draw_menu():
    ...
    sc.draw_centertext (' ERROR 403 :V]', font.menutitle_font, font.YELLOW,- 200)
    sc.draw_centertext (' sorry, Desmond is lazy to do this feature', font.menu_font, font.WHITE, 0)
    sc.draw_centertext('but he most likely not going to do this :^) ', font.menu_font, font.WHITE, 40)
