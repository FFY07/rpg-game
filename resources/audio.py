...
# BGM
battle_alt = f"{Path('resources/audio/bgm/sts_mind_bloom.wav')}"
...
class SoundEffects():
    def __init__(self):        
        self.click_sfx = pygame.mixer.Sound(f"{Path('resources/audio/game_effects/click.wav')}")

        self.sword_sfx = pygame.mixer.Sound(f"{Path('resources/audio/character_effects/unsheath_sword-6113.wav')}")

        self.reaper_basic = pygame.mixer.Sound(f"{Path('resources/audio/character_effects/Reaper/double_unsheath2.wav')}")
        ...
        self.tank_load_shell = pygame.mixer.Sound(f"{Path('resources/audio/character_effects/Tank/wot_load_shell.wav')}")
        self.tank_183mm = pygame.mixer.Sound(f"{Path('resources/audio/character_effects/Tank/wot_183mm.wav')}")

        self.magic_sfx = pygame.mixer.Sound(f"{Path('resources/audio/character_effects/1168-za-warudo-sound-effect.wav')}")
        self.magic_sfx.set_volume(0.4)

        self.potion_sfx = pygame.mixer.Sound(f"{Path('resources/audio/character_effects/potion.wav')}")
