...
class Unit(pygame.sprite.Sprite):
    ...
    def load_animations(self, reverse = False):
        ...
        for action in self.actions:
            path = Path(f"test_zone/resources2/images/units/{self.unit_name}/{action}")
    ...
    def update(self):
        ...
        if self.name == "Southpaw":
            print(self.name, self.action, self.frame, len(self.animations.get(self.action))) # debug
